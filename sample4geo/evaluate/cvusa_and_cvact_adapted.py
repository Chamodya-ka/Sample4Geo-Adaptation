...
def evaluate(config,
    ...
    print("\nExtract Features:")
    query_features, query_labels, query_features_stage3 = predict(config, model, query_dataloader)
    
    reference_features, reference_labels, _ = predict(config, model, reference_dataloader, query_features_stage3=query_features_stage3) 
